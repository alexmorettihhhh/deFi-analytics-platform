...
- WebSocket API используется для получения данных о торговых парах в реальном времени. Для работы с WebSocket, используйте эндпоинт `/ws/{pair}`, чтобы получать обновления о торгах.
